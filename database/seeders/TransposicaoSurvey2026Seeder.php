...
class TransposicaoSurvey2026Seeder extends Seeder
{
    public function run(): void
    {
        $survey = Survey::create([
            'name' => 'CPA Funcionários de Transposição 2026',
            'audience' => AudienceType::TRANSPOSICAO,
            'year' => 2026,
            'version' => 1,
            'is_active' => true,
            'intro_text' => <<<TEXT
Prezado(a) Funcionário de transposição(a),
