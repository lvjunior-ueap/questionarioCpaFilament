...
class EgressoSurvey2026Seeder extends Seeder
{
    public function run(): void
    {
        $survey = Survey::create([
            'name' => 'CPA Egresso 2026',
            'audience' => AudienceType::EGRESSO,
            'year' => 2026,
            'version' => 1,
            'is_active' => true,
            'intro_text' => <<<TEXT
...
TEXT
        ...
        */
        ...
        // A partir daqui entram as dimensões...
